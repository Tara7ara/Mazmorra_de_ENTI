                    ...
                    if (split_input.size > 1) {
                        if (split_input[0] == "go" && split_input.size == 2) {
                            if (split_input[1] == "north") {
                                if (Map1[player.posX - 1][player.posY] != '#' && player.posX - 1 >= 0 && !mapCollision(
                                        player.posX - 1,
                                        player.posY
                                    )
                                ) {
                                ...
                                if (Map1[player.posX + 1][player.posY] != '#' && player.posX + 1 <= 9 && !mapCollision(
                                        player.posX + 1,
                                        player.posY
                                    )
                                ) {
                                ...
                                if (Map2[player.posX][player.posY + 1] != '#' && player.posY + 1 <= 9 && !mapCollision(
                                        player.posX,
                                        player.posY + 1
                                    )
                                ) {
                                ...
                                if (Map1[player.posX][player.posY - 1] != '#' && !mapCollision(
                                        player.posX,
                                        player.posY - 1
                                    )
                                ) {
                            ...
                            help()
                            readLine()
                        } else if (split_input[0] == "inventory") {
                            inventory()
                            readLine()
                        } else {
                            println("esto no es un comando")
